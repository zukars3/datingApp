                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-group row">
                        <label for="relationship"
                               class="col-md-4 col-form-label text-md-right">{{ __('What is your relationship status?') }}</label>
                    ...
                    <div class="form-group row">
                        <label for="country"
                               class="col-md-4 col-form-label text-md-right">{{ __('Which country are you from?') }}</label>
                    ...
                    <div class="form-group row">
                        <label for="languages"
                               class="col-md-4 col-form-label text-md-right">{{ __('What languages do you speak?') }}</label>

                        <div class="col-md-6">
                                    <textarea class="form-control" id="languages" name="languages" rows="2"
                                              style="resize:none;" required
                                              autocomplete="languages">{{ old('languages') }}</textarea>
                        </div>
